...
def recognize_url(url):
    ...
    print('save rebuild.jpg');
    return pytesseract.image_to_string(Image.open('imgs/rebuild.jpg'),lang='eng',config="-c tessedit_char_whitelist=ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz --psm 7")
